...
export default function Home() {
  ...
  const cvData = {
    ...
    time: chinaTime,
    telegram: 'yofox',
    objective: 'Работаю с проектами от макета до финального развертывания. Мой практический опыт и гибкий подход позволяют быстро адаптироваться к новым задачам. Мой подход это решать задачи. Использую ИИ как шуруповерт, для ускорения, анализа и автоматизации. Могу быстро адаптироваться к новым задачам.',
    experience: {
