...
<body class="bg-gray-100">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            filterBtn.addEventListener('click', () => { filterModal.classList.remove('hidden'); overlay.classList.remove('hidden'); });
