...
export default function Home() {
    ...
    <div className="grid grid-cols-2 gap-2">
      <ProjectCard>
        <div className="flex flex-col items-center justify-center text-center gap-2">
            <Image src="https://img001.prntscr.com/file/img001/wjRTXBREQc618I5n23T2Yg.jpeg" alt="CV Face" width={48} height={48} className="grayscale rounded-full"/>
  ...
  const galleryContent = (
    <div className="space-y-4">
      <div className={`text-center font-mono text-sm ${isGreenButtonPressed ? 'text-green-500' : 'text-muted-foreground'}`}>
  ...
  return (
    <main className="p-2 sm:p-4 min-h-screen flex flex-col relative">
      ...
      <SecretCameraModal 
          ...
          onCapture={(imagePath) => setCapturedImages(prev => [...prev, imagePath])}
      />
